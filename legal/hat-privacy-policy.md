...
#
# HATDeX Privacy Policy

When you use our Platform services, you&#39;re trusting us with the security and safety of your microserver and the data within. We understand that this is a big responsibility and we work hard to protect your microserver, the data within, and put you in control of the instructions within your HAT.
...
HATDeX services enable you to collect Your Data from third party sources injecting data into your microserver and third party applications writing into your microserver and using our services to directly input data into your microserver through the control of your instructions. Your instructions enable you to operate on, transform, bundle and combine Your Data for exchange using our Services and the services of other third parties.

You are in control of the information you collect through the use of our Services and your instructions and can use the information for:

- ··transferring, exchanging, donating or giving Your Data to other HATs or third party applications through data debits and with your instructions
- ··fulfilling your instructions for creating new, insights, tools and algorithms that transform Your Data within your microserver or generate new data within your microserver
- ··viewing, filtering and searching Your Data with your instructions and our Services or third party applications that you permit

In all circumstances of using Your HAT Microserver, you are deemed to be a &quot;developer&quot; running the instructions and instruction code within your HAT. HATDeX have no access to Your Data and are not responsible for its contents, organisation, visibility and usage. HATDeX services (such as the HAT app) may facilitate the execution of your instructions.

We do not share Your Data with any third party. We merely facilitate the transfer of Your Data based on your instructions to do so executed through the data debit of your HAT.
...
Email: Please contact us at privacy@hatdex.org or via our website [https://hatdex.org/contact-us-2](https://hatdex.org/contact-us-2) .

## 6. HATDEX GLOBAL PRIVACY POLICY FOR HATDEX ACCOUNT DATA AND HAT DATA
...
## 7. INFORMATION THAT WE COLLECT AND PROCESS
...
### **9.3 OTHER PARTIES WITH YOUR CONSENT OR AT YOUR DIRECTION**
...
HATDeX deploys multiple layers of protection to protect personal data stored in the HAT, whether at rest, in transit or in use. A detailed description of how we secure your information is available in our security whitepaper at [https://hatdex.org/volume-1-issue-2-17th-of-june-2016](https://hatdex.org/volume-1-issue-2-17th-of-june-2016).

### **10.1 INTERNATIONAL TRANSFER OF DATA**
...
- ··If you would like to make a request to access your information, please contact us at contact@hatdex.org. HATDeX will provide access to the information you request within a reasonable period of time. HATDeX reserves the right to charge a reasonable fee for access requests.
- ··You may update the information you provided on the HAT app of your HAT Microserver (this feature is coming soon).
- ··You may request HATDeX to delete the information you provided by contacting HATDeX at contact@hatdex.org. HATDeX reserves the right to retain certain information when the law authorises or requires it to do so. Please note that deleting some information may disable the functioning of your HAT Microserver.
...
## 13. THIRD PARTY LINKS, PRODUCTS AND SERVICES ON OUR PLATFORM
...
8 Comberton Road, Barton, Cambridge CB23 7BA

You can also contact us at privacy@hatdex.org.

If you would like to exercise your rights to access, rectification, deletion/erasure, object, restrict processing, or portability, please visit our website [https://hatdex.org/contact-us-2](https://hatdex.org/contact-us-2).
